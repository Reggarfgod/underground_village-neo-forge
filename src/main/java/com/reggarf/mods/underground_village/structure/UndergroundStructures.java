...
public class UndergroundStructures extends Structure {
    ...
    public static final MapCodec<UndergroundStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(UndergroundStructures.configCodecBuilder(instance),
            ...
            ).apply(instance, UndergroundStructures::new));
    ...
    public UndergroundStructures(Config config,
    ...
    public Optional<StructurePosition> getStructurePosition(Context context) {
        ...
        if (!UndergroundStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return USStructures.UNDERGROUND_STRUCTURE; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
