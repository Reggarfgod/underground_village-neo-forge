...
public class UndergroundStructure extends Structure {
    ...
    public static final Codec<UndergroundStructure> CODEC = RecordCodecBuilder.create(instance ->
    ...
    public UndergroundStructure(StructureSettings config,
...
//            instance.group(
//                    com.reggarf.mods.underground_village.structure.UndergroundStructure.settingsCodec(instance),
...
//            ).apply(instance, com.reggarf.mods.underground_village.structure.UndergroundStructure::new));
//
//    private final Holder<StructureTemplatePool> startPool;
//    private final Optional<ResourceLocation> startJigsawName;
//    private final int size;
