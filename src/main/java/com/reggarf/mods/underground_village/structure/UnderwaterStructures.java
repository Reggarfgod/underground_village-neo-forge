...
public class UnderwaterStructures extends Structure {
    ...
    public static final MapCodec<Config> CUSTOM_STRUCTURE_SETTINGS_CODEC = RecordCodecBuilder.mapCodec(
            codecBuilder -> codecBuilder.group(
                            ...
                            Codec.simpleMap(SpawnGroup.CODEC, StructureSpawns.CODEC, StringIdentifiable.toKeyable(SpawnGroup.values()))
                                    ...
                                    .forGetter(Config::spawnOverrides),
                            GenerationStep.Feature.CODEC.fieldOf("step").forGetter(Config::step),
                            StructureTerrainAdaptation.CODEC.optionalFieldOf("terrain_adaptation", new Config(
                                    RegistryEntryList.of(), Map.of(), GenerationStep.Feature.SURFACE_STRUCTURES, StructureTerrainAdaptation.NONE
                            ).terrainAdaptation()).forGetter(Config::terrainAdaptation)
                    )
                    .apply(codecBuilder, Config::new)
    );
    ...
    public UnderwaterStructures(Config config,
                                ...
                                StructureLiquidSettings liquidSettings)
    {
        ...
        this.size = Underground_village.CONFIG.common.watermaxDistanceFromCenter;
    ...
    public StructureType<?> getType() {
        return USStructures.UNDERWATER_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
