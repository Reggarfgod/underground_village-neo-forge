...
public class UnderwaterStructures extends Structure {
    ...
    public static final MapCodec<UnderwaterStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(CUSTOM_STRUCTURE_SETTINGS_CODEC.forGetter(structureInfo -> structureInfo.modifiableStructureInfo().getOriginalStructureInfo().structureSettings()),
                    ...
                    Codec.intRange(1, 128).fieldOf("max_distance_from_center").forGetter(structure -> Underground_village.CONFIG.common.watermaxDistanceFromCenter),
    ...
    public UnderwaterStructures(StructureSettings config,
    ...
    public StructureType<?> type() {
        return USStructures.UNDERWATER_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
