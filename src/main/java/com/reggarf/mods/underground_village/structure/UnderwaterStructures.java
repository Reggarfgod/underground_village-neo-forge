...
public class UnderwaterStructures extends Structure {
    ...
    public static final MapCodec<UnderwaterStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
                    ...
                    Codec.intRange(1, 128).fieldOf("max_distance_from_center").forGetter(s -> Underground_village.CONFIG.common.watermaxDistanceFromCenter),
    ...
    public UnderwaterStructures(StructureSettings settings,
...
private static boolean extraSpawningChecks(GenerationContext context) {
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        int actualSize = Underground_village.CONFIG.common.waterstructureSize;
        int actualMaxDistance = Underground_village.CONFIG.common.watermaxDistanceFromCenter;
    ...
    public StructureType<?> type() {
        return USStructures.UNDERWATER_STRUCTURES.get();
    }
}
